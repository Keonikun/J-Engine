...
export default class Materials
{
    ...
    applyMaterials()
    {
        this.physMesh.children.forEach( element => {
            ...
            // if( element.material.name === "Textures" || element.material.name === "BakedMaterial")
            // {
            ...
            // }
            // if( element.material.name === "TexturesDoubleSide" || element.material.name === "BakedDoubleSideMaterial")
            // {
            //     element.material.side = THREE.DoubleSide
            //     element.material.precision = 'lowp'
            //     element.material = new THREE.MeshStandardMaterial().copy( element.material )
            // }
            // if( element.material.name === "EmmisiveTextures" || element.material.name === "BakedEmissiveMaterial")
            // {
            //     element.material.side = THREE.DoubleSide
            //     element.material.precision = 'lowp'
            //     element.material = new THREE.MeshStandardMaterial().copy( element.material )
